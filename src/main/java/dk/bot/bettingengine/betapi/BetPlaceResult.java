 ...
 * 
 */
public class BetPlaceResult implements BetResult{
	...
	public BetPlaceResult(long betId, Date betDate, String betType, double price, double size, double avgPriceMatched,
			double sizeMatched) {
		this.betId = betId;
